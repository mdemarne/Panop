...
class MasterSpec extends FlatSpec {
  ...
  "A master" should "start a very simple research of depth 0" in {
    ...
    master ! StartSearch(Url("https://www.admin.ch/opc/fr/classified-compilation/national.html"), Query("Etat" :: "Peuple" :: Nil, 0))
    Thread.sleep(1000)
  ...
  "A master" should "start a very simple research of depth 1" in {
    val master = asys.actorOf(Props(new Master(asys)))
    master ! StartSearch(Url("https://www.admin.ch/opc/fr/classified-compilation/national.html"), Query("Etat" :: "Peuple" :: Nil, 1))
    Thread.sleep(10000)
    master ! DisplayResults
    // TODO: proper testing
  }
